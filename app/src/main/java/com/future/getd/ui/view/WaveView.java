...
public class WaveView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isPause) {
            for (int i = 0; i < mCircleList.size(); i++) {
                ...
                int alpha = circle.lastAlpha;
                float radius = circle.lastRadius;
    ...
    private class Circle {
        ...
        int getAlpha() {
            ...
            lastAlpha = (int) (255 - mInterpolator.getInterpolation(percent) * 255);
            return (int) (255 - mInterpolator.getInterpolation(percent) * 255);
        }

        float getCurrentRadius() {
            float percent = (System.currentTimeMillis() - mCreateTime) * 1.0f / mDuration;
            lastRadius = mInitialRadius + mInterpolator.getInterpolation(percent) * (mMaxRadius - mInitialRadius);
