package com.future.getd.jl.rcsp;
...
public class BTRcspHelper {
    ...
    public static void setCurrentDevice(BluetoothDevice currentDevice) {
        BTRcspHelper.currentDevice = currentDevice;
    }
    ...
    public static void setBluetoothDevice(BluetoothDevice bluetoothDevice) {
        BTRcspHelper.bluetoothDevice = bluetoothDevice;
    }
    ...
    public static void setTargetDevice(BluetoothDevice targetDevice) {
        BTRcspHelper.targetDevice = targetDevice;
    }

    public static BleScanMessage getTargetBleScanMessage() {
        return targetBleScanMessage;
    }

    public static void setTargetBleScanMessage(BleScanMessage targetBleScanMessage) {
        BTRcspHelper.targetBleScanMessage = targetBleScanMessage;
    }
    ...
    public static void connectDeviceByMessage(RCSPController controller, Context context, BluetoothDevice device, BleScanMessage bleScanMessage) {
        if (bleScanMessage != null) {
            LogUtils.d("connect info bleScanMessage.getDeviceType() : " + bleScanMessage.getDeviceType());
            if (bleScanMessage.getDeviceType() == JL_DeviceType.JL_DEVICE_TYPE_TWS_HEADSET_V1
                ...
                LogUtils.d("connect info edrDevice : " + edrDevice + " , isEdrConnect " + isEdrConnect + " bleScanMessage.getAction() + " + bleScanMessage.getAction());
...
//                            ToastUtil.showToastShort(context.getString(R.string.device_connecting_tips));
            ...
            LogUtils.d("connect info getConnectWay way : " + way);
...
//    }
    ...
    private static boolean checkConnectedEdrIsOverLimit(RCSPController controller, BluetoothDevice device) {
        ...
        ret = count >= MULTI_DEVICE_MAX_NUMBER;
        return ret;
    }
