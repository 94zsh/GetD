...
//            window.addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_NAVIGATION);
    ...
    public static int getTextWidth(Paint paint, String demoText) {
     ...
     * @return
     */
    public static int getTextHeight(Paint paint, String demoText) {
    ...
    public static String saveTwo(float value){
        BigDecimal bigDecimal = BigDecimal.valueOf(value).setScale(2,BigDecimal.ROUND_DOWN);
