...
public class AsrUtil {
    ...
    public AsrUtil(Context context, CallBack callback) {
...
//            showTip("当前正在说话，音量大小 = " + volume + " 返回音频数据 = " + data.length);
    ...
    private String printResult(RecognizerResult results) {
        ...
        for (String key : mIatResults.keySet()) {
            resultBuffer.append(mIatResults.get(key));
            LogUtils.e( "resultBuffer: " + resultBuffer);
        }
...
//        mIat.setParameter(SpeechConstant.VAD_EOS, "1000");
        ...
        mIat.setParameter(SpeechConstant.ASR_AUDIO_PATH,
                MyApplication.getInstance().getExternalFilesDir("msc").getAbsolutePath() + "/iat.wav");
    }
